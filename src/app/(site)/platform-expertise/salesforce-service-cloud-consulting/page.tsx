...
export default async function SalesforceServiceCloudConsultingPage() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Salesforce Service Cloud Consulting | ProvidusCRM",
    "description": "Salesforce Service Cloud Consulting Services",
    "url": "https://providuscrm.co.uk/platform-expertise/salesforce-service-cloud-consulting",
    "provider": {
      "@type": "Organization",
      "name": "ProvidusCRM",
  ...
  const jsonLd = await getSitePageJsonLd("salesforce-service-cloud-consulting", schema);
