...
export async function generateMetadata(): Promise<Metadata> {
  return generateStaticPageMetadata("salesforce-experience-cloud-consulting", {
    title: "Salesforce Experience Cloud Consulting | ProvidusCRM",
    description: "Salesforce Experience Cloud Consulting Services",
    canonicalPath: "/platform-expertise/salesforce-experience-cloud-consulting",
  });
}
...
export default async function SalesforceExperienceCloudConsultingPage() {
  ...
  const blogs = await getPageBlogs("salesforce-experience-cloud-consulting");

  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Salesforce Experience Cloud Consulting | ProvidusCRM",
    "description": "Salesforce Experience Cloud Consulting Services",
    "url": "https://providuscrm.co.uk/platform-expertise/salesforce-experience-cloud-consulting",
    "provider": {
      "@type": "Organization",
      "name": "ProvidusCRM",
  ...
  const jsonLd = await getSitePageJsonLd("salesforce-experience-cloud-consulting", schema);
